...
| T-13 | Test | DONE | T-03…T-12 | Unit, integration, golden, determinism, regression, red-team: 61 test |
...
| T-16 | Risolvere il conflitto D-11 | **BLOCKED** | approvazione | Decisione del fondatore su D-11 |
| T-17 | Conferma dei parametri D-02 ("dimensioni principali") | TODO | approvazione | Conferma o modifica di `max_missing_core_dimensions` e della lista `core` |
...
| C | Produce Impact Score | ⚠️ implementato, ma mai raggiungibile con sola GitHub (D-11) |
| D | Confidence | ✅ |
| E | Evidence Coverage | ✅ |
| F | Risk | ✅ |
| G | Missing data | ✅ |
...
| K | Markdown | ✅ |
| L | Test automatici | ✅ |
| M | Verificato su repository reali | ⚠️ uno solo (T-14 bloccato) |
| N | Documentato | ✅ |
| O | Red-team iniziale | ✅ |
